...
import { isValid as isValid$1 } from '@fnando/cpf';
...
var set = function set(colorKey, shadeOriginal, shadeDark, shadeLight, shadeCrystal) {
  ...
  colors = _objectSpread({}, colors, (_objectSpread3 = {}, _defineProperty$1(_objectSpread3, colorKey, colorOriginal), _defineProperty$1(_objectSpread3, "shades", _objectSpread({}, colors.shades, _defineProperty$1({}, colorKey, getShadesFormat(colorDark, colorOriginal, colorLight, colorCrystal)))), _objectSpread3));
  return colors;
};
/**
...
var palette = {};
var excluded = [].concat(_toConsumableArray(colors$1.aliasKeys), _toConsumableArray(colors$1.statusKeys), ['poison', 'translucid']);

for (var colorKey in colors$1.shades) {
  var color = colors$1.shades[colorKey];

  if (!excluded.includes(colorKey) && _typeof$1(color) === 'object' && color.light && color.dark) {
    palette[colorKey] = {
      start: color.dark,
      end: color.light
    };
...
function get$1() {
  var paletteShade = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '';
...
function backgroundLinear() {
  var paletteShade = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '';
  var deg = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 0;
  ...
  return "linear-gradient(".concat(deg, "deg, ").concat(start, ", ").concat(end, ")");
}
/**
 * Mapping
 */
...
var ActionBarStyled = _styled("div", {
  ...
  return props.styles;
}, ";" + (process.env.NODE_ENV === "production" ? "" : "/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */"));
...
var ActionBar = forwardRef(function (_ref, ref) {
  var className = _ref.className,
      visible = _ref.visible,
      rest = _objectWithoutProperties(_ref, ["className", "visible"]);

  /**
   * Render
   */
  return React.createElement(ActionBarStyled, _extends({}, rest, {
    ref: ref,
...
_styled('img', {
  ...
  if (center) {
    _extraStyles = _objectSpread$1({}, _extraStyles, {
      display: 'block',
      margin: '0 auto'
    });
  }
...
var Img = forwardRef(function (props, ref) {
  var center = props.center,
      ...
      onLoad = props.onLoad,
      fadeIn = props.fadeIn,
      rest = _objectWithoutProperties$1(props, ["center", "src", "srcFallback", "className", "onError", "onLoad", "fadeIn"]);
  /**
   * Local values
   */
  ...
  function handleError(errorEvt) {
    ...
    if (typeof onError === 'function') {
      onError(_objectSpread$2({}, errorEvt || {}));
    }
  }
  /**
   * Did update
  ...
  return React.createElement(ImgStyled, _extends$1({}, rest, {
    center: center,
    ref: ref,
    src: managedSRC,
    onLoad: handleLoad,
...
function Avatar(_ref) {
  var center = _ref.center,
      ...
      src = _ref.src,
      rest = _objectWithoutProperties$2(_ref, ["center", "circle", "color", "fontSize", "initials", "gradient", "margin", "name", "size", "width", "height", "styles", "radius", "className", "src"]);
  ...
  if (!display) {
    return React.createElement(Img, _extends$2({
      src: src,
      width: (width || size) + 'px',
  ...
  return React.createElement(AvatarStyled, _extends$2({
    role: "img",
    aphCenter: center,
    aphCircle: circle,
...
function useWindowSize() {
  ...
  var isClient = (typeof window === "undefined" ? "undefined" : _typeof$2(window)) === 'object';
  /**
   * Get Window Size
   */
...
function Badge(_ref) {
  var padding = _ref.padding,
      ...
      rest = _objectWithoutProperties$3(_ref, ["padding", "radius", "styles", "className", "prefix", "suffix", "children"]);
  ...
  return React.createElement(Segment, _extends$3({}, rest, {
  ...
  }), !prefix ? null : React.createElement(Segment, _extends$3({
    padding: "0"
  }, prefix, {
    className: "aph-badge__prefix ".concat(prefix.className || '')
  })), children, !suffix ? null : React.createElement(Segment, _extends$3({
    padding: "0"
  }, suffix, {
...
var Button = forwardRef(function (props, ref) {
  ...
  var block = props.block,
      ...
      rest = _objectWithoutProperties$4(props, ["block", "circle", "className", "color", "children", "loading", "disabled", "margin", "link", "radius", "sm", "small", "styles", "translucid"]);
  /**
   * Local values
   */
  ...
  return React.createElement(AphButtonStyled, _extends$4({}, rest, {
    ref: ref,
    aphsm: sm || small ? 1 : 0,
    aphblock: block ? 1 : 0,
    aphcircle: circle,
  ...
  }, !loading ? null : React.createElement(Icon, {
    size: 30,
    slug: "loader",
...
var AphCardStyled = _styled("div", {
  ...
  return props.styles;
}, ";" + (process.env.NODE_ENV === "production" ? "" : "/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */"));
/* Component Itself */


var Card = forwardRef(function (props, ref) {
  var className = props.className;
  return React.createElement(AphCardStyled, _extends$5({}, props, {
    ref: ref,
...
var Clipboard = function Clipboard(props) {
  ...
  var styled = props.styled,
      ...
      onError = props.onError,
      rest = _objectWithoutProperties$5(props, ["styled", "styles", "className", "onSuccess", "onError"]);
  /**
   * Local values
   */
  ...
  if (!styled) {
    return React.createElement(AphClipboardWrapper, _extends$6({}, clipboardProps, {
      className: "aph-clipboard ".concat(className || '')
    }));
  }

  return React.createElement(ClipboardStyled, _extends$6({}, clipboardProps, {
    as: ReactClipboard,
...
function Dialog(_ref) {
  ...
  }, children), !closeArea ? null : React.createElement("div", {
    onClick: onClose,
...
function ExpansionPanel(props) {
  var header = props.header,
      ...
      rest = _objectWithoutProperties$6(props, ["header", "children", "expanded", "expandedCallback", "styles", "headerStyles"]);
  ...
  return React.createElement(ExpansionPanelWrapper, _extends$7({}, rest, {
    styles: styles,
    className: "aph-expansion-panel"
  }), React.createElement(ExpansionPanelHeader, {
    onClick: toggle,
    headerStyles: headerStyles,
    className: "aph-expansion-panel__header"
  }, header), React.createElement(ExpansionPanelContent, {
    opened: opened,
...
function HoverActions(props) {
  ...
  var actions = props.actions,
      className = props.className,
      children = props.children,
      rest = _objectWithoutProperties$7(props, ["actions", "className", "children"]);
  /**
   * Render
   */


  return React.createElement(HoverActionsStyled, _extends$8({
...
var IconWrapper = _styled("svg", {
  ...
  return props.aphStyles;
}, ";" + (process.env.NODE_ENV === "production" ? "" : "/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */"));
/* Component it self */
...
var Icon = forwardRef(function (props, ref) {
  ...
  var color = props.color,
      className = props.className,
      styles = props.styles,
      rest = _objectWithoutProperties$8(props, ["color", "className", "styles"]);
  /**
   * Render
   */


  return React.createElement(IconWrapper, _extends$9({}, rest, {
    ref: ref,
    as: SelectedIcon,
    aphStyles: styles,
...
var NumberFormat = forwardRef(function (props, ref) {
   ...
   */
  var className = props.className,
      rest = _objectWithoutProperties$9(props, ["className"]);
  /**
   * Render
   */


  return React.createElement(AphNumberFormatStyled, _extends$a({}, rest, {
...
var Placeholder = forwardRef(function (props, ref) {
  var _ref = props || {},
      className = _ref.className,
      styles = _ref.styles,
      rest = _objectWithoutProperties$a(_ref, ["className", "styles"]);
  ...
  return React.createElement(StyledPlaceholder, _extends$b({}, rest, {
    ref: ref,
...
var SegmentStyled = _styled("div", {
  ...
  return props.aphstyles;
}, ";" + (process.env.NODE_ENV === "production" ? "" : "/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */"));
/* Component Itself */
...
var Segment = forwardRef(function (props, ref) {
  var className = props.className,
      ...
      shadow = props.shadow,
      styles = props.styles,
      rest = _objectWithoutProperties$b(props, ["className", "margin", "padding", "color", "background", "hoverable", "radius", "shadow", "styles"]);

  return React.createElement(SegmentStyled, _extends$c({}, rest, {
    ref: ref,
    aphmargin: margin,
    aphpadding: padding,
...
var Table = forwardRef(function (props, ref) {
  var className = props.className,
      children = props.children;
  return React.createElement(AphTableStyled, _extends$d({}, props, {
    ref: ref,
...
var _ref = process.env.NODE_ENV === "production" ? {
  ...
  name: "94kjoh",
  styles: ".Toastify__toast-container{z-index:9999;position:fixed;padding:4px;width:320px;box-sizing:border-box;color:#fff}.Toastify__toast-container--top-left{top:1em;left:1em}.Toastify__toast-container--top-center{top:1em;left:50%;margin-left:-160px}.Toastify__toast-container--top-right{top:1em;right:1em}.Toastify__toast-container--bottom-left{bottom:1em;left:1em}.Toastify__toast-container--bottom-center{bottom:1em;left:50%;margin-left:-160px}.Toastify__toast-container--bottom-right{bottom:1em;right:1em}@media only screen and (max-width:480px){.Toastify__toast-container{width:100vw;padding:0;left:0;margin:0}.Toastify__toast-container--top-center,.Toastify__toast-container--top-left,.Toastify__toast-container--top-right{top:0}.Toastify__toast-container--bottom-center,.Toastify__toast-container--bottom-left,.Toastify__toast-container--bottom-right{bottom:0}.Toastify__toast-container--rtl{right:0;left:auto}}.Toastify__toast{position:relative;min-height:64px;box-sizing:border-box;margin-bottom:1rem;padding:8px;border-radius:1px;box-shadow:0 1px 10px 0 rgba(0,0,0,.1),0 2px 15px 0 rgba(0,0,0,.05);display:-ms-flexbox;display:flex;-ms-flex-pack:justify;justify-content:space-between;max-height:800px;overflow:hidden;font-family:sans-serif;cursor:pointer;direction:ltr}.Toastify__toast--rtl{direction:rtl}.Toastify__toast--default{background:#fff;color:#aaa}.Toastify__toast--info{background:#3498db}.Toastify__toast--success{background:#07bc0c}.Toastify__toast--warning{background:#f1c40f}.Toastify__toast--error{background:#e74c3c}.Toastify__toast-body{margin:auto 0;-ms-flex:1;flex:1}@media only screen and (max-width:480px){.Toastify__toast{margin-bottom:0}}.Toastify__close-button{color:#fff;font-weight:700;font-size:14px;background:transparent;outline:none;border:none;padding:0;cursor:pointer;opacity:.7;transition:.3s ease;-ms-flex-item-align:start;align-self:flex-start}.Toastify__close-button--default{color:#000;opacity:.3}.Toastify__close-button:focus,.Toastify__close-button:hover{opacity:1}@keyframes Toastify__trackProgress{0%{transform:scaleX(1)}to{transform:scaleX(0)}}.Toastify__progress-bar{position:absolute;bottom:0;left:0;width:100%;height:5px;z-index:9999;opacity:.7;background-color:hsla(0,0%,100%,.7);transform-origin:left}.Toastify__progress-bar--animated{animation:Toastify__trackProgress linear 1 forwards}.Toastify__progress-bar--controlled{transition:transform .2s}.Toastify__progress-bar--rtl{right:0;left:auto;transform-origin:right}.Toastify__progress-bar--default{background:linear-gradient(90deg,#4cd964,#5ac8fa,#007aff,#34aadc,#5856d6,#ff2d55)}@keyframes Toastify__bounceInRight{0%,60%,75%,90%,to{animation-timing-function:cubic-bezier(.215,.61,.355,1)}0%{opacity:0;transform:translate3d(3000px,0,0)}60%{opacity:1;transform:translate3d(-25px,0,0)}75%{transform:translate3d(10px,0,0)}90%{transform:translate3d(-5px,0,0)}to{transform:none}}@keyframes Toastify__bounceOutRight{20%{opacity:1;transform:translate3d(-20px,0,0)}to{opacity:0;transform:translate3d(2000px,0,0)}}@keyframes Toastify__bounceInLeft{0%,60%,75%,90%,to{animation-timing-function:cubic-bezier(.215,.61,.355,1)}0%{opacity:0;transform:translate3d(-3000px,0,0)}60%{opacity:1;transform:translate3d(25px,0,0)}75%{transform:translate3d(-10px,0,0)}90%{transform:translate3d(5px,0,0)}to{transform:none}}@keyframes Toastify__bounceOutLeft{20%{opacity:1;transform:translate3d(20px,0,0)}to{opacity:0;transform:translate3d(-2000px,0,0)}}@keyframes Toastify__bounceInUp{0%,60%,75%,90%,to{animation-timing-function:cubic-bezier(.215,.61,.355,1)}0%{opacity:0;transform:translate3d(0,3000px,0)}60%{opacity:1;transform:translate3d(0,-20px,0)}75%{transform:translate3d(0,10px,0)}90%{transform:translate3d(0,-5px,0)}to{transform:translateZ(0)}}@keyframes Toastify__bounceOutUp{20%{transform:translate3d(0,-10px,0)}40%,45%{opacity:1;transform:translate3d(0,20px,0)}to{opacity:0;transform:translate3d(0,-2000px,0)}}@keyframes Toastify__bounceInDown{0%,60%,75%,90%,to{animation-timing-function:cubic-bezier(.215,.61,.355,1)}0%{opacity:0;transform:translate3d(0,-3000px,0)}60%{opacity:1;transform:translate3d(0,25px,0)}75%{transform:translate3d(0,-10px,0)}90%{transform:translate3d(0,5px,0)}to{transform:none}}@keyframes Toastify__bounceOutDown{20%{transform:translate3d(0,10px,0)}40%,45%{opacity:1;transform:translate3d(0,-20px,0)}to{opacity:0;transform:translate3d(0,2000px,0)}}.Toastify__bounce-enter--bottom-left,.Toastify__bounce-enter--top-left{animation-name:Toastify__bounceInLeft}.Toastify__bounce-enter--bottom-right,.Toastify__bounce-enter--top-right{animation-name:Toastify__bounceInRight}.Toastify__bounce-enter--top-center{animation-name:Toastify__bounceInDown}.Toastify__bounce-enter--bottom-center{animation-name:Toastify__bounceInUp}.Toastify__bounce-exit--bottom-left,.Toastify__bounce-exit--top-left{animation-name:Toastify__bounceOutLeft}.Toastify__bounce-exit--bottom-right,.Toastify__bounce-exit--top-right{animation-name:Toastify__bounceOutRight}.Toastify__bounce-exit--top-center{animation-name:Toastify__bounceOutUp}.Toastify__bounce-exit--bottom-center{animation-name:Toastify__bounceOutDown}@keyframes Toastify__zoomIn{0%{opacity:0;transform:scale3d(.3,.3,.3)}50%{opacity:1}}@keyframes Toastify__zoomOut{0%{opacity:1}50%{opacity:0;transform:scale3d(.3,.3,.3)}to{opacity:0}}.Toastify__zoom-enter{animation-name:Toastify__zoomIn}.Toastify__zoom-exit{animation-name:Toastify__zoomOut}@keyframes Toastify__flipIn{0%{transform:perspective(400px) rotateX(90deg);animation-timing-function:ease-in;opacity:0}40%{transform:perspective(400px) rotateX(-20deg);animation-timing-function:ease-in}60%{transform:perspective(400px) rotateX(10deg);opacity:1}80%{transform:perspective(400px) rotateX(-5deg)}to{transform:perspective(400px)}}@keyframes Toastify__flipOut{0%{transform:perspective(400px)}30%{transform:perspective(400px) rotateX(-20deg);opacity:1}to{transform:perspective(400px) rotateX(90deg);opacity:0}}.Toastify__flip-enter{animation-name:Toastify__flipIn}.Toastify__flip-exit{animation-name:Toastify__flipOut}@keyframes Toastify__slideInRight{0%{transform:translate3d(110%,0,0);visibility:visible}to{transform:translateZ(0)}}@keyframes Toastify__slideInLeft{0%{transform:translate3d(-110%,0,0);visibility:visible}to{transform:translateZ(0)}}@keyframes Toastify__slideInUp{0%{transform:translate3d(0,110%,0);visibility:visible}to{transform:translateZ(0)}}@keyframes Toastify__slideInDown{0%{transform:translate3d(0,-110%,0);visibility:visible}to{transform:translateZ(0)}}@keyframes Toastify__slideOutRight{0%{transform:translateZ(0)}to{visibility:hidden;transform:translate3d(110%,0,0)}}@keyframes Toastify__slideOutLeft{0%{transform:translateZ(0)}to{visibility:hidden;transform:translate3d(-110%,0,0)}}@keyframes Toastify__slideOutDown{0%{transform:translateZ(0)}to{visibility:hidden;transform:translate3d(0,500px,0)}}@keyframes Toastify__slideOutUp{0%{transform:translateZ(0)}to{visibility:hidden;transform:translate3d(0,-500px,0)}}.Toastify__slide-enter--bottom-left,.Toastify__slide-enter--top-left{animation-name:Toastify__slideInLeft}.Toastify__slide-enter--bottom-right,.Toastify__slide-enter--top-right{animation-name:Toastify__slideInRight}.Toastify__slide-enter--top-center{animation-name:Toastify__slideInDown}.Toastify__slide-enter--bottom-center{animation-name:Toastify__slideInUp}.Toastify__slide-exit--bottom-left,.Toastify__slide-exit--top-left{animation-name:Toastify__slideOutLeft}.Toastify__slide-exit--bottom-right,.Toastify__slide-exit--top-right{animation-name:Toastify__slideOutRight}.Toastify__slide-exit--top-center{animation-name:Toastify__slideOutUp}.Toastify__slide-exit--bottom-center{animation-name:Toastify__slideOutDown}",
  map: "/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */",
...
var ToastsContainer = function ToastsContainer() {
  ...
  })), process.env.NODE_ENV === "production" ? "" : "/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */");

  return React.createElement(AphToastsContainer, {
    className: "aph-toasts-container",
    styles: props.styles
  }, React.createElement(ToastsStyles, null), React.createElement(ToastContainer, _extends$e({}, props, {
...
var Tooltip = forwardRef(function (props, ref) {
  ...
  return React.createElement(TooltipWrapper, _extends$f({}, customProps, {
    ref: ref
  }), React.createElement("span", {
    "data-tip": props.tip,
    "data-for": customProps.id,
    className: "aph-tooltip__content"
  }, props.children), React.createElement(ReactTooltip, _extends$f({}, customProps, {
...
var ModalStyled = _styled("dialog", {
  ...
  return props.styles;
}, ";", MEDIA_QUERIES.LT.SM, "{top:20px;right:10px;left:10px;", selector$1, "{&__container{&__title{padding:25px 0 15px;}&__header{padding-top:0;}}}}" + (process.env.NODE_ENV === "production" ? "" : "/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */"));
...
var _ref$1 = process.env.NODE_ENV === "production" ? {
  ...
  name: "1sy9iaq",
  styles: "body{overflow:hidden;}",
  map: "/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */",
...
var Modal = forwardRef(function (props, ref) {
  ...
  var title = props.title,
      ...
      rest = _objectWithoutProperties$c(props, ["title", "header", "contentJustify", "alignItems", "children", "footer", "footerProps", "overlayProps", "className", "styles", "opened", "openedCallback", "closeOnEscape", "closeByEscape", "unblockScrolling"]);
  /**
   * State values
   */
  ...
  return React.createElement(React.Fragment, null, React.createElement(ModalOverlayStyled, _extends$g({
  ...
  }, overlayProps)), React.createElement(ModalStyled, _extends$g({}, rest, {
    ref: modalRef,
    open: true,
  ...
  }, children))), React.createElement(ActionBar, _extends$g({}, footerProps, {
...
var SidePill = memo(function (props) {
  ...
  return React.createElement(SidePillStyled, _extends$h({}, props, {
...
var A = forwardRef(function (props, ref) {
  var className = props.className,
      color = props.color,
      rest = _objectWithoutProperties$d(props, ["className", "color"]);

  return React.createElement(AStyled, _extends$i({}, rest, {
    ref: ref,
    textColor: color,
...
var H1Styled = _styled("h1", {
  ...
  return props.styles;
}, ";" + (process.env.NODE_ENV === "production" ? "" : "/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */"));
/* Component Itself */
...
var H1 = forwardRef(function (props, ref) {
  var className = props.className,
      ...
      lower = props.lower,
      upper = props.upper,
      rest = _objectWithoutProperties$e(props, ["className", "color", "align", "center", "left", "right", "lower", "upper"]);

  return React.createElement(H1Styled, _extends$j({
    textAlign: align,
    textColor: color,
    textLeft: left,
    textCenter: center,
...
var H2Styled = _styled("h2", {
  ...
  return props.styles;
}, ";" + (process.env.NODE_ENV === "production" ? "" : "/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */"));
/* Component Itself */
...
var H2 = forwardRef(function (props, ref) {
  var className = props.className,
      ...
      lower = props.lower,
      upper = props.upper,
      rest = _objectWithoutProperties$f(props, ["className", "color", "align", "center", "left", "right", "lower", "upper"]);

  return React.createElement(H2Styled, _extends$k({
    textAlign: align,
    textLeft: left,
    textCenter: center,
    textRight: right,
...
var H3 = forwardRef(function (props, ref) {
  var className = props.className,
      ...
      lower = props.lower,
      upper = props.upper,
      rest = _objectWithoutProperties$g(props, ["className", "color", "align", "center", "left", "right", "lower", "upper"]);

  return React.createElement(H3Styled, _extends$l({
    textAlign: align,
    textLeft: left,
    textCenter: center,
    textRight: right,
...
var P = forwardRef(function (props, ref) {
  var className = props.className,
      ...
      upper = props.upper,
      small = props.small,
      rest = _objectWithoutProperties$h(props, ["className", "color", "align", "center", "left", "right", "lower", "upper", "small"]);

  return React.createElement(PStyled, _extends$m({
    textAlign: align,
    textLeft: left,
    textCenter: center,
    textRight: right,
...
function Label(props) {
  ...
  var className = props.className,
      styles = props.styles,
      rest = _objectWithoutProperties$i(props, ["className", "styles"]);
  /**
   * Render
   */


  return React.createElement(P, _extends$n({
    bold: true,
    small: true,
    upper: true,
    margin: "5px 0",
...
function _objectSpread$c(target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i] != null ? arguments[i] : {}; if (i % 2) { ownKeys$c(Object(source), true).forEach(function (key) { _defineProperty$e(target, key, source[key]); }); } else if (Object.getOwnPropertyDescriptors) { Object.defineProperties(target, Object.getOwnPropertyDescriptors(source)); } else { ownKeys$c(Object(source)).forEach(function (key) { Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key)); }); } } return target; }
...
var Container = forwardRef(function (props, ref) {
  return React.createElement(AphContainer, _extends$o({}, props, {
    ref: ref,
...
function _objectSpread$d(target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i] != null ? arguments[i] : {}; if (i % 2) { ownKeys$d(Object(source), true).forEach(function (key) { _defineProperty$f(target, key, source[key]); }); } else if (Object.getOwnPropertyDescriptors) { Object.defineProperties(target, Object.getOwnPropertyDescriptors(source)); } else { ownKeys$d(Object(source)).forEach(function (key) { Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key)); }); } } return target; }
...
var Row = forwardRef(function (props, ref) {
  var className = props.className,
      children = props.children;
  return React.createElement(RowWrapper, _extends$p({}, props, {
    ref: ref,
...
_styled('div', {
  ...
  }, gridStyles, (_objectSpread2 = {}, _defineProperty$g(_objectSpread2, MEDIA_QUERIES.LT.SM, {
...
var Column = forwardRef(function (props, ref) {
  var first = props.first,
      ...
      className = props.className,
      children = props.children,
      rest = _objectWithoutProperties$j(props, ["first", "last", "width", "styles", "xxs", "xs", "sm", "md", "lg", "xl", "className", "children"]);
  /**
   * Render
   */


  return React.createElement(ColStyled, _extends$q({}, rest, {
    gridFirst: first,
    gridLast: last,
    gridXXS: xxs,
    gridXS: xs,
...
function Flex$1(props) {
  ...
  return React.createElement(AphFlex, _extends$r({}, props, {
...
var List = forwardRef(function (props, ref) {
  var className = props.className;
  return React.createElement(AphListStyled, _extends$s({
    role: "listbox"
  }, props, {
    ref: ref,
...
var AphListItemStyled = _styled("li", {
  ...
  return !props.borderTop && !props.borderBottom ? null : "inset 0 ".concat(props.borderBottom ? '-' : '', "1px 0 0 ").concat(colors$1.getOpacity(0.25, colors$1.getFromTheme(props, 'helper')));
  ...
  return props.styles;
}, ";" + (process.env.NODE_ENV === "production" ? "" : "/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */"));
/* Component Itself */
...
var ListItem = forwardRef(function (props, ref) {
  var className = props.className,
      ...
      padding = props.padding,
      rest = _objectWithoutProperties$k(props, ["className", "component", "withLink", "padding"]);

  var AphListItem = component ? AphListItemStyled.withComponent(component, {
    target: "e6wegxb1"
  }) : AphListItemStyled;
  return React.createElement(AphListItem, _extends$t({
    role: "option",
    aphpadding: padding,
    withLink: withLink
  }, rest, {
...
var ListGroup = forwardRef(function (props, ref) {
  return React.createElement(AphListGroup, _extends$u({}, props, {
    ref: ref,
...
var ListGroupItem = forwardRef(function (props, ref) {
  var className = props.className,
      children = props.children;
  return React.createElement(AphListGroupItem, _extends$v({}, props, {
    ref: forwardRef,
...
var Collapsible = forwardRef(function (props, ref) {
  ...
  return React.createElement(Card, _extends$w({}, props, {
    ref: ref,
    hover: true,
  ...
  }), !header ? null : React.createElement(HeaderTitle, _extends$w({}, headerProps, {
...
function Countdown(_ref) {
  var background = _ref.background,
      ...
      rest = _objectWithoutProperties$l(_ref, ["background", "className", "color", "log", "size", "seconds", "strokeWidth", "styles", "onFinishCallback"]);
  ...
  return React.createElement(CountdownStyled, _extends$x({}, rest, {
    aphBackground: background,
    aphColor: color,
...
function Pagination(props) {
  ...
  var loading = props.loading,
      className = props.className,
      rest = _objectWithoutProperties$m(props, ["loading", "className"]);
  /**
   * Render
   */


  return React.createElement(AphPaginationStyled, _extends$y({
    locale: localeInfo,
    showLessItems: true
  }, rest, {
...
var AphCheckboxWrapperStyled = _styled("div", {
  ...
  name: "g9qje4",
  styles: "box-sizing:border-box;display:block;position:relative;",
  map: "/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */",
...
var AphCheckboxMaskStyled = _styled("label", {
  ...
  return colors$1.getFromTheme(props, 'inverse');
}, ";background-size:20px;background-position:center;background-repeat:no-repeat;}" + (process.env.NODE_ENV === "production" ? "" : "/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */"));
/* Component Styles */
...
}, "');}}" + (process.env.NODE_ENV === "production" ? "" : "/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */"));
/* Component Itself */
...
var Checkbox = forwardRef(function (props, ref) {
  ...
  return React.createElement(AphCheckboxWrapperStyled, null, React.createElement(AphCheckboxStyled, _extends$z({
    className: "aph-form-control ".concat(className || '')
  }, newProps, {
    ref: ref,
    type: "checkbox"
  })), React.createElement(AphCheckboxMaskStyled, _extends$z({
...
var FormControlStyled = _styled("input", {
  ...
  return props.styles;
}, ";" + (process.env.NODE_ENV === "production" ? "" : "/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */"));
...
function _slicedToArray$a(arr, i) { return _arrayWithHoles$a(arr) || _iterableToArrayLimit$a(arr, i) || _nonIterableRest$a(); }

function _nonIterableRest$a() { throw new TypeError("Invalid attempt to destructure non-iterable instance"); }

function _iterableToArrayLimit$a(arr, i) { if (!(Symbol.iterator in Object(arr) || Object.prototype.toString.call(arr) === "[object Arguments]")) { return; } var _arr = []; var _n = true; var _d = false; var _e = undefined; try { for (var _i = arr[Symbol.iterator](), _s; !(_n = (_s = _i.next()).done); _n = true) { _arr.push(_s.value); if (i && _arr.length === i) break; } } catch (err) { _d = true; _e = err; } finally { try { if (!_n && _i["return"] != null) _i["return"](); } finally { if (_d) throw _e; } } return _arr; }

function _arrayWithHoles$a(arr) { if (Array.isArray(arr)) return arr; }
/* Component Itself */

var InputNumber = memo(forwardRef(function (props, ref) {
  var id = props.id,
      className = props.className,
      label = props.label,
      labelProps = props.labelProps,
  ...
  return React.createElement(AphFormControlWrapperStyled, null, React.createElement(FormControlStyled, _extends$A({}, inheritProps, {
    as: LibInputNumber,
    ref: ref,
  ...
  })), !label ? null : React.createElement(AphFormControlLabelStyled, _extends$A({}, labelProps, {
    htmlFor: id,
...
var InputNumber$1 = memo(forwardRef(function (props, ref) {
  var id = props.id,
      className = props.className,
      label = props.label,
      labelProps = props.labelProps,
  ...
  return React.createElement(AphFormControlWrapperStyled, null, React.createElement(FormControlStyled, _extends$B({}, inheritProps, {
    as: CurrencyInput,
    ref: ref,
    hasLabel: label ? true : false,
    ...
    className: "aph-form-control ".concat(className || '')
  })), !label ? null : React.createElement(AphFormControlLabelStyled, _extends$B({}, labelProps, {
    htmlFor: id,
...
var AphFormControlButtonStyled = _styled("button", {
  ...
  return props.styles;
}, ";" + (process.env.NODE_ENV === "production" ? "" : "/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */"));

function _slicedToArray$b(arr, i) { return _arrayWithHoles$b(arr) || _iterableToArrayLimit$b(arr, i) || _nonIterableRest$b(); }

function _nonIterableRest$b() { throw new TypeError("Invalid attempt to destructure non-iterable instance"); }

function _iterableToArrayLimit$b(arr, i) { if (!(Symbol.iterator in Object(arr) || Object.prototype.toString.call(arr) === "[object Arguments]")) { return; } var _arr = []; var _n = true; var _d = false; var _e = undefined; try { for (var _i = arr[Symbol.iterator](), _s; !(_n = (_s = _i.next()).done); _n = true) { _arr.push(_s.value); if (i && _arr.length === i) break; } } catch (err) { _d = true; _e = err; } finally { try { if (!_n && _i["return"] != null) _i["return"](); } finally { if (_d) throw _e; } } return _arr; }
...
var Input = memo(forwardRef(function (props, ref) {
  ...
  if (type === 'checkbox') {
    return React.createElement(Checkbox, _extends$C({}, props, {
  ...
  if (type === 'number') {
    return React.createElement(InputNumber, _extends$C({}, props, {
      ref: ref
    }));
  }

  if (type === 'currency') {
    return React.createElement(InputNumber$1, _extends$C({}, props, {
      ref: ref
    }));
  }
  ...
  return React.createElement(AphFormControlWrapperStyled, {
  ...
  }, React.createElement(FormControlStyled, _extends$C({
    name: id
  }, props, {
    ref: ref,
    hasLabel: label ? true : false,
    ...
    onPaste: handlePaste,
    className: "aph-form-control ".concat(!label || !label && hasValue ? 'aph-form-control--middle' : '', " ").concat(className || '')
  })), !label ? null : React.createElement(AphFormControlLabelStyled, _extends$C({}, labelProps, {
    htmlFor: id,
    className: "aph-form-label ".concat(placeholder || hasValue ? 'aph-form-label--top' : '')
  }), label), !btn && !button ? null : React.createElement(AphFormControlButtonStyled, null, React.createElement("span", _extends$C({}, btn, button))), React.createElement(AphFormControlErrorMsgStyled, {
    htmlFor: id,
    styles: !errorMessage ? null : {
      maxHeight: '600px'
    },
...
function InputMask(props) {
   ...
   * Render
   */
  return React.createElement(LibInputMask, props, function (inputProps) {
...
function cpfValidator() {
  var cpf = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '';
...
function _objectSpread$i(target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i] != null ? arguments[i] : {}; if (i % 2) { ownKeys$i(Object(source), true).forEach(function (key) { _defineProperty$k(target, key, source[key]); }); } else if (Object.getOwnPropertyDescriptors) { Object.defineProperties(target, Object.getOwnPropertyDescriptors(source)); } else { ownKeys$i(Object(source)).forEach(function (key) { Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key)); }); } } return target; }

function _defineProperty$k(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }

function _slicedToArray$c(arr, i) { return _arrayWithHoles$c(arr) || _iterableToArrayLimit$c(arr, i) || _nonIterableRest$c(); }

function _nonIterableRest$c() { throw new TypeError("Invalid attempt to destructure non-iterable instance"); }

function _iterableToArrayLimit$c(arr, i) { if (!(Symbol.iterator in Object(arr) || Object.prototype.toString.call(arr) === "[object Arguments]")) { return; } var _arr = []; var _n = true; var _d = false; var _e = undefined; try { for (var _i = arr[Symbol.iterator](), _s; !(_n = (_s = _i.next()).done); _n = true) { _arr.push(_s.value); if (i && _arr.length === i) break; } } catch (err) { _d = true; _e = err; } finally { try { if (!_n && _i["return"] != null) _i["return"](); } finally { if (_d) throw _e; } } return _arr; }
...
function InputCpf(_ref) {
  var error = _ref.error,
      ...
      pMask = _ref.mask,
      rest = _objectWithoutProperties$n(_ref, ["error", "onChange", "mask"]);
  ...
  return React.createElement(InputMask, _extends$D({
    mask: mask,
...
function _objectSpread$j(target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i] != null ? arguments[i] : {}; if (i % 2) { ownKeys$j(Object(source), true).forEach(function (key) { _defineProperty$l(target, key, source[key]); }); } else if (Object.getOwnPropertyDescriptors) { Object.defineProperties(target, Object.getOwnPropertyDescriptors(source)); } else { ownKeys$j(Object(source)).forEach(function (key) { Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key)); }); } } return target; }
...
function Autocomplete(props) {
  ...
  return React.createElement(AphFormControlWrapperStyled, null, isAsync ? React.createElement(AsyncSelect, _extends$E({
    styles: customStyles
  }, props)) : React.createElement(Select$1, _extends$E({
    styles: customStyles
  }, props)), error && React.createElement(AphFormControlErrorMsgStyled, null, error));
}
/* Prop Types */
...
function _slicedToArray$d(arr, i) { return _arrayWithHoles$d(arr) || _iterableToArrayLimit$d(arr, i) || _nonIterableRest$d(); }

function _nonIterableRest$d() { throw new TypeError("Invalid attempt to destructure non-iterable instance"); }

function _iterableToArrayLimit$d(arr, i) { if (!(Symbol.iterator in Object(arr) || Object.prototype.toString.call(arr) === "[object Arguments]")) { return; } var _arr = []; var _n = true; var _d = false; var _e = undefined; try { for (var _i = arr[Symbol.iterator](), _s; !(_n = (_s = _i.next()).done); _n = true) { _arr.push(_s.value); if (i && _arr.length === i) break; } } catch (err) { _d = true; _e = err; } finally { try { if (!_n && _i["return"] != null) _i["return"](); } finally { if (_d) throw _e; } } return _arr; }

function _arrayWithHoles$d(arr) { if (Array.isArray(arr)) return arr; }
/* Component Itself */

var Select = memo(forwardRef(function (props, ref) {
  var id = props.id,
      label = props.label,
      labelProps = props.labelProps,
      placeholder = props.placeholder,
  ...
  return React.createElement(AphFormControlWrapperStyled, null, React.createElement(FormControlStyled, _extends$F({}, props, {
    as: "select",
    ref: ref,
    hasLabel: label ? true : false,
    onChange: handleChange,
    styles: Object.assign({}, styles, props.styles)
  })), !label ? null : React.createElement(AphFormControlLabelStyled, _extends$F({}, labelProps, {
    htmlFor: id,
    className: "aph-form-label ".concat(placeholder || hasValue ? 'aph-form-label--top' : '')
...
function _slicedToArray$e(arr, i) { return _arrayWithHoles$e(arr) || _iterableToArrayLimit$e(arr, i) || _nonIterableRest$e(); }

function _nonIterableRest$e() { throw new TypeError("Invalid attempt to destructure non-iterable instance"); }

function _iterableToArrayLimit$e(arr, i) { if (!(Symbol.iterator in Object(arr) || Object.prototype.toString.call(arr) === "[object Arguments]")) { return; } var _arr = []; var _n = true; var _d = false; var _e = undefined; try { for (var _i = arr[Symbol.iterator](), _s; !(_n = (_s = _i.next()).done); _n = true) { _arr.push(_s.value); if (i && _arr.length === i) break; } } catch (err) { _d = true; _e = err; } finally { try { if (!_n && _i["return"] != null) _i["return"](); } finally { if (_d) throw _e; } } return _arr; }

function _arrayWithHoles$e(arr) { if (Array.isArray(arr)) return arr; }
/* Component Itself */

var TextArea = memo(forwardRef(function (props, ref) {
  var id = props.id,
      label = props.label,
      labelProps = props.labelProps,
      placeholder = props.placeholder,
  ...
  return React.createElement(AphFormControlWrapperStyled, null, React.createElement(FormControlStyled, _extends$G({}, props, {
    as: "textarea",
    hasLabel: label ? true : false,
    onChange: handleChange,
    styles: styles
  })), !label ? null : React.createElement(AphFormControlLabelStyled, _extends$G({}, labelProps, {
    htmlFor: inputId,
    className: "aph-form-label ".concat(placeholder || hasValue ? 'aph-form-label--top' : '')
  }), label), React.createElement(AphFormControlErrorMsgStyled, {
    htmlFor: inputId,
...
var AphFormSwitchWrapper = _styled("label", {
  ...
  return props.styles;
}, ";" + (process.env.NODE_ENV === "production" ? "" : "/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */"));
/* Component Toggle Wrapper Styles */


var AphFormSwitchToggleWrapper = _styled("label", {
  target: "e3wo45e1"
})(aphFormSwitchCommonStyles, ";position:absolute;display:block;top:50%;transform:translateY(-50%);line-height:0;" + (process.env.NODE_ENV === "production" ? "" : "/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */"));
/* Component Toggle Styles */


var AphFormSwitchToggle = _styled("label", {
  target: "e3wo45e2"
})(aphFormSwitchCommonStyles, ";position:absolute;top:0;width:30px;height:30px;transition-property:right,left;transition-duration:0.25s;transition-timing-function:ease;border-radius:50%;box-shadow:0 0 5px 0 ", colors$1.get('black', 'original', 0.25), ";background-color:", function (props) {
  return colors$1.getFromTheme(props, 'white');
}, ";" + (process.env.NODE_ENV === "production" ? "" : "/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */"));
...
}, ";}}+ .aph-form-switch{&__toggle{left:0;}}" + (process.env.NODE_ENV === "production" ? "" : "/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */"));
...
}, ";" + (process.env.NODE_ENV === "production" ? "" : "/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */"));
/* Component Styles */
...
var Switch = memo(forwardRef(function (props, ref) {
  ...
  return React.createElement(SwitchStyled.Wrapper, {
    htmlFor: id,
  ...
  }, React.createElement(SwitchStyled.ToggleWrapper, {
    htmlFor: id,
    className: "aph-form-switch__wrapper"
  }, React.createElement(SwitchStyled.Input, _extends$H({}, newProps, {
    ref: ref,
    id: id,
    type: "checkbox",
    className: "aph-form-switch__input"
  })), React.createElement(SwitchStyled.Toggle, {
    htmlFor: id,
    className: "aph-form-switch__toggle"
  })), !children ? null : React.createElement(SwitchStyled.Content, {
    htmlFor: id,
...
var RadioButtonWrapper = _styled("label", {
  ...
  name: "1uu9qb9",
  styles: "display:flex;align-items:center;cursor:pointer;position:relative;padding-top:5px;padding-left:40px;padding-bottom:5px;",
  map: "/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */",
...
}, ";border-radius:100%;}}&:disabled ~ i{border:1px solid ", colors$1.get('disabled'), ";}" + (process.env.NODE_ENV === "production" ? "" : "/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */"));
...
function RadioButton(_ref) {
  var id = _ref.id,
      ...
      rest = _objectWithoutProperties$o(_ref, ["id", "name", "children", "checked", "type", "value", "disabled"]);

  return React.createElement(RadioButtonWrapper, _extends$I({
    htmlFor: id
  }, rest), React.createElement(RadioButtonInput, {
    id: id,
    name: name,
    ...
    value: value,
    disabled: disabled
  }), React.createElement("i", null), React.createElement("span", null, children));
}
/* Default props */
...
export { A, ANIMATIONS, ActionBar, Autocomplete, Avatar, Badge, Button, COLORS, Card, Checkbox, Clipboard, Column as Col, Collapsible, Column, Container, Countdown, Dialog, Dropdown, ExpansionPanel, FORM, Flex$1 as Flex, GRID, H1, H2, H3, HoverActions, HoverActionItem as HoverActionsItem, ICONS, Icon, Img, Input, InputCpf, InputNumber$1 as InputCurrency, InputMask, InputNumber, LAYOUT, Label, A as Link, List, ListGroup, ListGroupItem, ListItem, MEDIA_QUERIES, Modal, NumberFormat, P, Pagination, Placeholder, ProgressBar, RADIUS, RadioButton, Row, SCREEN_SIZES, SIZES, Scrollable, Segment, Select, SidePill, Switch, Table, P as Text, TextArea, ToastsContainer, Tooltip, ZINDEX, animations, cnpjValidator, colors$1 as colors, cpfValidator, emailValidator, gradients, layoutActions, sort, text, textAlign, textBreakAll, textColorfull, textDefinitions, textTransform, textTruncate, toast, useWindowSize };
