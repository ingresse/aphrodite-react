...
for (var colorKey in colors$1.shades) {
  ...
  if (colorKey !== 'translucid' && _typeof$1(color) === 'object' && color.light && color.dark) {
    palette[colorKey] = {
      start: color.dark,
      end: color.light
    };
