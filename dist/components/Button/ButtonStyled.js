...
var AphButtonStyled = (0, _styledBase.default)("button", {
  ...
  return _utils.colors.get('mercury', props.translucid ? 'crystal' : 'light');
}, ";background-color:", function (props) {
  return props.link ? _utils.colors.get('smoke') : props.translucid ? _utils.colors.get('smoke', '', 0.5) : _utils.colors.get('mercury', 'crystal');
