...
0, _styledBase.default)('div', {
  ...
  }, _objectSpread2["flexBasis"] = width || _constants.GRID.COLUMNS_GET_WIDTH(xxs || xs) || '100%', _objectSpread2.maxWidth = width || _constants.GRID.COLUMNS_GET_WIDTH(xxs || xs) || '100%', _objectSpread2), styles, (_objectSpread3 = {}, _objectSpread3[_constants.MEDIA_QUERIES.LT.SM] = {
    flexBasis: _constants.GRID.COLUMNS_GET_WIDTH(xs),
    maxWidth: _constants.GRID.COLUMNS_GET_WIDTH(xs),
    order: getOrder('xs')
  }, _objectSpread3[_constants.MEDIA_QUERIES.GT.SM] = {
    flexBasis: _constants.GRID.COLUMNS_GET_WIDTH(sm),
    maxWidth: _constants.GRID.COLUMNS_GET_WIDTH(sm),
    order: getOrder('sm')
  }, _objectSpread3[_constants.MEDIA_QUERIES.GT.MD] = {
    flexBasis: _constants.GRID.COLUMNS_GET_WIDTH(md),
    maxWidth: _constants.GRID.COLUMNS_GET_WIDTH(md),
    order: getOrder('md')
  }, _objectSpread3[_constants.MEDIA_QUERIES.GT.LG] = {
    flexBasis: _constants.GRID.COLUMNS_GET_WIDTH(lg),
    maxWidth: _constants.GRID.COLUMNS_GET_WIDTH(lg),
    order: getOrder('lg')
  }, _objectSpread3[_constants.MEDIA_QUERIES.GT.XL] = {
