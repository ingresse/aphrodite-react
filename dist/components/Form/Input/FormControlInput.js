...
var _FormControlCurrency = _interopRequireDefault(require("../Currency/FormControlCurrency"));
...
var Input = (0, _react.forwardRef)(function (props, ref) {
  ...
  if (type === 'currency') {
    return _react.default.createElement(_FormControlCurrency.default, _extends({}, props, {
      ref: ref
    }));
  }
