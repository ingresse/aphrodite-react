...
var SegmentStyled = (0, _styledBase.default)("div", {
  ...
  return props.aphshadow ? "0 0 3px " + _utils.colors.getFromTheme(props, 'oil', 'dark', 0.25) : props.borderTop || props.borderBottom ? "inset 0 " + (props.borderBottom ? '-' : '') + "1px 0 0 " + _utils.colors.getOpacity(0.25, _utils.colors.getFromTheme(props, 'helper')) : null;
