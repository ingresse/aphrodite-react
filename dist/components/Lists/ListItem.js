...
var AphListItemStyled = (0, _styledBase.default)("li", {
  ...
  return _utils.colors.getFromTheme(props, props.theme && props.theme.isDarkMode ? 'background' : 'secondary', 'crystal');
}, ";}", function (props) {
  return props.onClick ? {
    ...
    '&:hover': {
      color: _utils.colors.getFromTheme(props, 'secondary'),
      backgroundColor: _utils.colors.getFromTheme(props, props.theme && props.theme.isDarkMode ? 'background' : 'secondary', 'crystal')
    }
  } : null;
}, ";", function (props) {
