...
var AphListItemStyled = (0, _styledBase.default)("li", {
  ...
  return !props.borderTop && !props.borderBottom ? null : "inset 0 " + (props.borderBottom ? '-' : '') + "1px 0 0 " + _utils.colors.getOpacity(0.25, _utils.colors.getFromTheme(props, props.theme && props.theme.isDarkMode ? 'inverse' : 'helper'));
  ...
  return _utils.colors.getFromTheme(props, props.theme && props.theme.isDarkMode ? 'inverse' : 'secondary', 'crystal');
}, ";}", function (props) {
