...
0, _styledBase.default)('span', {
  ...
  return _objectSpread((_objectSpread2 = {
    ...
    boxShadow: "0 0 1px 0 " + _constants.COLORS.GET('DARK_BLACK', 0.2),
...
0, _styledBase.default)('span', {
  ...
  return _objectSpread((_objectSpread3 = {
    ...
    textAlign: 'center',
    borderRadius: _constants.RADIUS.XS + _constants.GRID.UNIT + " 0 0 " + (_constants.RADIUS.XS + _constants.GRID.UNIT)
  }, _objectSpread3[_constants.MEDIA_QUERIES.LT.SM] = {
    fontSize: '16px',
    lineHeight: '20px',
    margin: '-10px 10px -10px -15px',
    padding: '5px 6px',
    borderRadius: _constants.RADIUS.XS + _constants.GRID.UNIT + " 0 0 " + (_constants.RADIUS.XS + _constants.GRID.UNIT)
  }, _objectSpread3), props.styles);
...
var Badge = (0, _react.forwardRef)(function (props, ref) {
  ...
  var prefix = !props.sm ? {} : (_ref = {
    paddingRight: '8px',
    paddingLeft: '8px',
    marginLeft: '-8px',
    marginRight: '6px',
    borderRadius: _constants.RADIUS.XXS + _constants.GRID.UNIT + " 0 0 " + (_constants.RADIUS.XXS + _constants.GRID.UNIT)
  }, _ref[_constants.MEDIA_QUERIES.LT.SM] = {
    fontSize: '16px',
    lineHeight: '20px',
    margin: '-10px 10px -10px -15px',
    padding: '5px 8px',
