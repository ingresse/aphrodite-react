            ...
            <div>
                ...
                <Container xl style={containerExample}>
                    ...
                    <div style={contentExample}>
                        And the content maximum width is <strong>{(GRID.CONTAINER.XL - GRID.CONTAINER_PADDING) + GRID.UNIT}</strong>.
                    </div>
                </Container>
                ...
                <Container style={containerExample}>
                    ...
                    <div style={contentExample}>
                        And the content maximum width is <strong>{(GRID.CONTAINER - GRID.CONTAINER_PADDING) + GRID.UNIT}</strong>.
                    </div>
                </Container>
                ...
                <Container md style={containerExample}>
                    ...
                    <div style={contentExample}>
                        And the content maximum width is <strong>{(GRID.CONTAINER.MD - GRID.CONTAINER_PADDING) + GRID.UNIT}</strong>.
                    </div>
                </Container>
                ...
                <Container sm style={containerExample}>
                    ...
                    <div style={contentExample}>
                        And the content maximum width is <strong>{(GRID.CONTAINER.SM - GRID.CONTAINER_PADDING) + GRID.UNIT}</strong>.
                    </div>
                </Container>
                ...
                <Container xs style={containerExample}>
                    ...
                    <div style={contentExample}>
                        And the content maximum width is <strong>{(GRID.CONTAINER.XS - GRID.CONTAINER_PADDING) + GRID.UNIT}</strong>.
                    </div>
                </Container>

                <Container xs noPadding style={{ border: `1px solid ${COLORS.DARK_GREY}` }}>
                    noPadding Example
                </Container>
            </div>
        );
...
<Playground style={{ padding: '0 20px' }}>
    {() => {
        ...
        const columnsExample = {
            color       : COLORS.WHITE,
            background  : COLORS.TONES.PURPLE,
            ...
            borderRight : `${GRID.COLUMNS_PADDING}px solid ${COLORS.PURPLE}`,
            borderLeft  : `${GRID.COLUMNS_PADDING}px solid ${COLORS.PURPLE}`,
        };
