...
/* Icon Itself */
const IconPaymentFreepass = (props) => {
    /**
     * Inherit props
     */
    const {
...
/* Exporting */
export default IconPaymentFreepass;
